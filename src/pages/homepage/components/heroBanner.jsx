...
const HeroBanner = () => {
	return (
		<div>
			<div className="bg-beig dark:bg-primaryblue mt-5 dark:pt-5 dark:mt-0 flex flex-col md:flex-row md:justify-evenly px-9">
				<div className="max-w-7xl px-4 sm:px-6 lg:px-20 py-10 flex flex-col justify-center">
				...
				<img src={hero} alt="heroimg" className="max-w-md lg:max-w-lg mb-10 mr-10 md:mr-0 md:mt-20 lg:my-10 dark:hidden" />
				<img src={heroDark} alt="heroimg" className="max-w-md lg:max-w-lg mb-10 mr-10 lg:my-10 hidden dark:block" />
			</div>
		</div>
	);
};
