        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="bg-white">
                <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 className="text-2xl font-bold font-heading tracking-tight text-gray-900 ">PRODUCTS</h2>
                            ...
                            <div key={product.id} className="group relative flex flex-col gap-y-3">
                                ...
                                <div className="mt-4 flex justify-between">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500 overflow-hidden">{product.description}</p>
                                    </div>
